...
export default function Contact() {
  return (
    <section className='relative w-[100vw] pt-20'>
      <div className='flex lg:flex-row lg:justify-end justify-center items-center mx-5 sm:mx-10 md:mx-20 lg:mr-[10rem]'>
      ...
      <figure className='invisible lg:visible h-[105vh] w-[100vw] absolute top-0 left-0 mr-20 mb-20'>
        <Tomato />
      </figure>
    </section>
  );
